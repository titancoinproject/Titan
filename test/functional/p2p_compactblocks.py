...
# TestNode: A peer we use to send messages to titancoind, and store responses.
...
class CompactBlocksTest(TitancoinTestFramework):
    ...
    # This test actually causes titancoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that titancoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for titancoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # titancoind will not send blocktxn responses for blocks whose height is
