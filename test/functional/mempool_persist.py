...
By default, titancoind will dump mempool on shutdown and
...
class MempoolPersistTest(TitancoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give titancoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent titancoind from writing mempool.dat to disk. Verify that `savemempool` fails")
