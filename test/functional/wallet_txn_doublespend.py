...
class TxnMallTest(TitancoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 TTN:
        ...
        # First: use raw transaction API to send 1240 TTN to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 TTN coin each
        ...
        # Node0's balance should be starting balance, plus 50TTN for another
        ...
        # Node0's total balance should be starting balance, plus 100TTN for 
