...
find ${DISTNAME}/bin -type f -executable -exec ../titancoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../titancoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/titancoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/titancoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
