...
#ifndef TTN_QT_TTNGUI_H
#define TTN_QT_TTNGUI_H
...
/**
  Titancoin GUI main class. This class represents the main window of the Titancoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TitancoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TitancoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~TitancoinGUI();
