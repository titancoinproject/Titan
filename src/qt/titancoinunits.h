...
#ifndef TTN_QT_TTNUNITS_H
#define TTN_QT_TTNUNITS_H
...
/** Titancoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TitancoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TitancoinUnits(QObject *parent);

    /** Titancoin units.
      @note Source: https://en.titancoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TTN,
...
typedef TitancoinUnits::Unit TitancoinUnit;

#endif // TTN_QT_TTNUNITS_H
